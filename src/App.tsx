...
function buildChannelHeatmap(urlRows, yr, launchDates) {
  ...
  const urlCurves = Object.values(byChannelUrl)
    .map(({ ch, cu, dates }) => {
  ...
  urlCurves.forEach((u) => {
    if (!byChannel[u.ch])
      byChannel[u.ch] = { urls: [], tot: 0, earliestLd: u.ld };
      ...
      >
        ...
        {[
          ...
          <button
            ...
            style={btnStyle(viewMode === v, "#5c6bc0")}
          >
            {l}
          </button>
        ))}
          ...
          return (
            <div style={{ marginTop: 14, overflowX: "auto" }}>
              <div style={{ fontSize: 11, color: "#666", marginBottom: 6 }}>
                {title} — each row = one channel, day-0 = earliest launch date
                in that channel
              </div>
              <table
                style={{
              ...
              <p style={{ fontSize: 11, color: "#999", marginTop: 8 }}>
                Launch date = earliest LP visit across all URLs in that channel.
                Heatmap intensity = % of channel total in that week.
              </p>
            </div>
          );
        })()}
        ...
        <>
          ...
          >
            <p style={{ fontSize: 11, color: "#999", margin: 0 }}>
              ...
              Heatmap = % of URL total in that week. Each row = one distinct
              clean URL.
            </p>
